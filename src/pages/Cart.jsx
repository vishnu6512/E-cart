                            ...
                            <table className='table-auto w-full'>
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>product</td>
                                        <td><img width={'70px'} height={'70px'} src="https://images.unsplash.com/photo-1498579397066-22750a3cb424?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8Z3JvY2VyeXxlbnwwfHwwfHx8MA%3D%3D" alt="" /></td>
                                        <td>
                                            <div className='flex'>
